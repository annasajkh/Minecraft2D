...
public class Player extends Entity
{
    ...
    public void update()
    {
        ...
        float dirX = x - Minecraft2D.camera.position.x;
        float dirY = y - Minecraft2D.camera.position.y;
        ...
        if (!(length <= 0.0001f))
        {
            ...
            Minecraft2D.camera.position.x += dirX * length * Minecraft2D.cameraSmoothFactor * Gdx.graphics.getDeltaTime();
            Minecraft2D.camera.position.y += dirY * length * Minecraft2D.cameraSmoothFactor * Gdx.graphics.getDeltaTime();
        }
        //--------------------------------------
    ...
    public void drawUI(SpriteBatch spriteBatch, ShapeRenderer shapeRenderer)
    {
        ...
        shapeRenderer.rect(Gdx.graphics.getWidth() * 0.5f - Minecraft2D.itemSize * inventory.length * 0.5f - Minecraft2D.itemSize * 0.5f - 10,
                           0, Minecraft2D.itemSize * inventory.length + 20,
        ...
        for (int i = 0; i < inventory.length; i++)
        {
            ...
            {
                posX = Gdx.graphics.getWidth() * 0.5f + i * Minecraft2D.itemSize - inventory.length * Minecraft2D.itemSize * 0.5f;
                posY = Minecraft2D.itemSize * 0.5f + 10;
                spriteBatch.draw(inventory[i].texture, posX - Minecraft2D.itemSize * 0.5f, posY - Minecraft2D.itemSize * 0.5f, Minecraft2D.itemSize, Minecraft2D.itemSize);
            }
        }
        ...
        for (int i = 0; i < inventory.length; i++)
        {
            if (inventory[i].texture != null)
            {
                ...
                {
                    Minecraft2D.font.draw(spriteBatch, String.valueOf((int) inventory[i].count), posX - Minecraft2D.size * 0.25f, posY);
                }
            }
        }
        ...
        for (int i = 0; i < inventory.length; i++)
        {
            ...
            shapeRenderer.rect(posX - Minecraft2D.itemSize * 0.5f, posY - Minecraft2D.itemSize * 0.5f, Minecraft2D.itemSize, Minecraft2D.itemSize);
        }

        posX = Gdx.graphics.getWidth() * 0.5f + selectedInventoryIndex * Minecraft2D.itemSize - inventory.length * Minecraft2D.itemSize * 0.5f;
        posY = Minecraft2D.itemSize * 0.5f + 10;
